...
const ReputationGrid = () => {
    const reputationItems = [
        { src: "/images/backgrounds/section_certifications.png", title: "Global Certifications", desc: "ISO, HACCP, FSSAI Certified", size: "col-span-2 row-span-2" },
        { src: "/images/content/cardamom_closeup.png", title: "Quality Control", desc: "Rigorous laboratory testing", size: "col-span-1 row-span-1" },
        { src: "/images/content/heritage_warehouse.jpg", title: "Legacy Warehouse", desc: "Our Bodinayakanur heritage", size: "col-span-1 row-span-1" },
        { src: "/images/content/sustainability.jpg", title: "Eco Commitment", desc: "Solar-powered facilities", size: "col-span-1 row-span-2" },
        { src: "/images/backgrounds/section_global_export.png", title: "Global Reach", desc: "Serving 40+ countries", size: "col-span-2 row-span-1" },
        { src: "/images/backgrounds/section_about_heritage.png", title: "Generational Bond", desc: "Working with local farmers", size: "col-span-1 row-span-1" }
    ];
