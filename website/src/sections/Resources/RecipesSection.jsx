...
5. Strain into cups, add sugar.
        ...
        },
        {
            ...
            region: 'South Asia',
            image: '/images/content/cardamom_pods_v2.png',
            prepTime: '45 min',
            difficulty: 'Easy',
...
6. Freeze until firm.
        ...
        },
        {
            ...
            region: 'India',
            image: '/images/cardamom_content/cardamom_biryani.png',
            prepTime: '1.5 hours',
            difficulty: 'Hard',
        ...
        <React.Fragment>
            <section id="recipes" className="section section-white section-center" style={{ position: 'relative', overflow: 'hidden' }}>
                ...
                <Modal
                    ...
                    size="xlarge"
                >
                    <div className="all-recipes-grid" style={{
                        display: 'grid',
                    ...
                    <style>{`
                        @media (max-width: 768px) {
                            ...
                            .all-recipes-grid > div {
                                border-radius: 8px !important;
                            }
                            .all-recipes-grid img {
                                height: 70px !important;
                            }
                            .all-recipes-grid > div > div:last-child {
