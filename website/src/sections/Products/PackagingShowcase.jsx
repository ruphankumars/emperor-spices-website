...
const PackagingShowcase = () => {
    const pouches = [
        { src: "/images/brand_reference/Emperor_brand_pouch_blue.jpg", color: "Sapphire Blue", grade: "AGEB 8mm+", desc: "The Gold Standard of Cardamom" },
        { src: "/images/brand_reference/Emperor_brand_pouch_red.jpg", color: "Ruby Red", grade: "1kg Bulk Pack", desc: "For High-Volume Gourmet Kitchens" },
        { src: "/images/brand_reference/Emperor_brand_pouch_fanta.jpg", color: "Fanta Orange", grade: "Select 7.5mm", desc: "Vibrant Aroma, Peak Freshness" },
        { src: "/images/brand_reference/Emperor_brand_pouch_magenta_pink.jpg", color: "Magenta Pink", grade: "Organic Certified", desc: "Chemical-Free Heritage Batches" },
        { src: "/images/brand_reference/Emperor_brand_pouch_violet.jpg", color: "Royal Violet", grade: "Limited Harvest", desc: "The Rarest Pods from the Peak" }
    ];
